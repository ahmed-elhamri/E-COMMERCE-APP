// *********************
// Role of the component: Helper component for seperating dynamic client component from back-end component on the single product page with the intention to preserve SEO benefits of Next.js
